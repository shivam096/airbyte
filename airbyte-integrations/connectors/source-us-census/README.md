...
```
Once the command is done, you will find your connector image in your local docker registry: `airbyte/source-us-census:dev`.
...
```Dockerfile
FROM airbyte/source-us-census:latest
...
docker run airbyte/source-us-census:dev spec
